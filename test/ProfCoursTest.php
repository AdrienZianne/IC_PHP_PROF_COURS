...
class ProfCoursTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void {
        ...
        self::$cours_a = [
            ...
            new Cours("IA", "12", 3),       // idcours = 1
            new Cours("EDL", "5", 6),       // idcours = 1
    ...
    public function testPrintAll()
    {
        ...
        print "########## - LISTE DES COURSS - AVANT TOUT ########## \n";
    ...
    public function testUpdateOne()
    {
        ...
        // Cours
        $cours = new Cours($this->intitule, $this->duree, $this->id_prof);
    ...
    public function testDeleteOne()
    {
        ...
        $record_cours_a = Cours::printAll($conn);
        print "########## - LISTE DES COURSS APRES SUPPRESSION- Vérifiez le cours num $idCours ########## \n";
        foreach ( $record_cours_a as $record_cours ) {
            print $record_cours;
        }
        print "################################################################\n\n";
    ...
    public function testDeleteOne_2()
    {
        ...
        $record_cours_a = Cours::printAll($conn);
        print "########## - LISTE DES COURSS APRES SUPPRESSION- Vérifier avec celui juste avant (1e supprimer) ########## \n";
        foreach ( $record_cours_a as $record_cours ) {
            print $record_cours;
        }
        print "################################################################\n\n";
